...
//      #endif
  ...
  if (current_block != NULL) {
    ...
    if ((((out_bits & (1<<E_AXIS)) != 0)&&(out_bits & (1<<E_AXIS)) != 0)) {   
      CHECK_ENDSTOPS
      {
        #if defined(E_MIN_PIN) && E_MIN_PIN > -1
          bool e_min_endstop=(READ(E_MIN_PIN) != E_ENDSTOPS_INVERTING);
      ...
      CHECK_ENDSTOPS 
      {
          ...
          bool e_max_endstop=(READ(E_MAX_PIN) != E_ENDSTOPS_INVERTING);
