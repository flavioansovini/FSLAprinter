...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define E0_ENABLE_PIN      24
    #define E_MIN_PIN          -1
    #define E_MAX_PIN          68 //analog pin ADC14
  ...
  #define TEMP_BED_PIN       -1//14   // ANALOG NUMBERING
    ...
    #define SERVO0_PIN         11
      ...
      #define LCD_PINS_D7 29
        ...
        #define LCD_PINS_D5 34//35 il 35 è rotto e lo ho cc con il 34 
...
#else
  #define SENSITIVE_PINS {0, 1, X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, X_MIN_PIN, X_MAX_PIN, Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, Y_MIN_PIN, Y_MAX_PIN, Z_STEP_PIN, Z_DIR_PIN, Z_ENABLE_PIN, Z_MIN_PIN, Z_MAX_PIN, E_MAX_PIN, PS_ON_PIN, \
                          HEATER_BED_PIN, FAN_PIN,                  \
                          _E0_PINS _E1_PINS _E2_PINS             \
                          analogInputToDigitalPin(TEMP_0_PIN), analogInputToDigitalPin(TEMP_1_PIN), analogInputToDigitalPin(TEMP_2_PIN), analogInputToDigitalPin(TEMP_BED_PIN) }
#endif
